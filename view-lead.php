                                                ...
                                                <table id="example" class="table">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            <td>
                                                                <?php 
                                                                $result1 = mysqli_query($conn,"SELECT  * FROM tbl_users where u_id = '".$row["lead_assigned"]."'");
                                                                $row1=mysqli_fetch_assoc($result1);
                                                                echo $row1["u_name"]; 
                                                                ?>
                                                            </td>
                                                            ...
                                                            <?php if($_SESSION['role'] == "Admin"){?>
                                                            <td>
                                                            <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#exampleModal" onclick='removedata(<?php echo $row["lead_id"]; ?>)'>Delete</button></td>
                                                            <?php }?>
    ...
    <script>
        ...
        function fetch_select(val){
            ...
            $.ajax({
                ...
                datatype:'json',
                data: {status:myArray[0],id:myArray[1],filename:myArray[2]},
