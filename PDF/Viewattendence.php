...
class myPDF extends FPDF
{
	...
	function headerTabale()
	{
		...
		$this->Cell(60,10,'User Name',1,0,'C');
		$this->Cell(70,10,'In - Date / Time',1,0,'C');
		$this->Cell(70,10,'Out - Date / Time',1,0,'C');
		$this->Cell(55,10,'Working Hours',1,0,'C');
		$this->Ln();
	}
	function ViewTbale($conn)
	{
		...
		while ($users = mysqli_fetch_assoc($result)) {
			...
			$this->Cell(60,10,$users['u_name'],1,0,'C');
			$this->Cell(70,10,$users['cdate'],1,0,'C');
			$this->Cell(70,10,$users['udate'],1,0,'C');
			if($users["udate"] == "")
            {	
