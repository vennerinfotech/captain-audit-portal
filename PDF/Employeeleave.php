...
class myPDF extends FPDF
{
	...
	function header()
	{
		...
		$this->Cell(276,10,'Employee Leave Document',0,0,'C');
		$this->Ln(20);
	}
	function footer()
	{
	...
	function headerTabale()
	{
		...
		$this->Cell(40,10,'Total Days',1,0,'C');
		$this->Cell(65,10,'Reson',1,0,'C');
	...
	function ViewTbale($conn)
	{
		...
		while ($users = mysqli_fetch_assoc($result)) {
			...
			$this->Cell(40,10,$users['ul_startdate'],1,0,'C');
			$this->Cell(40,10,$users['ul_enddate'],1,0,'C');
			$this->Cell(40,10,$dateDiff,1,0,'C');
			$this->Cell(65,10,$users['ul_reason'],1,0,'C');
