                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <form method="POST" action="process/assignsttask.php?edit=<?php echo $_GET['edit']; ?>">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <?php 
                                                                $id=$_GET['edit'];
                                                                $result=mysqli_query($conn,"SELECT * FROM `tbl_admintask`, `tbl_users` where `tbl_admintask`.store_id = `tbl_users`.u_id And task_id='$id'") or die(mysqli_error($conn));
                                                                $row=mysqli_fetch_assoc($result)
                                                            ?>
                                                            <label>Project Name</label>
                                                            <input readonly="true" type="text" class="form-control" id="Projectname" name="projectname" value="<?php echo 'Store: '.$row['u_name'].' Task: '.$row['p_naem'];  ?>"  placeholder="Enter Your Project Name"  required>
                                                        </div>
