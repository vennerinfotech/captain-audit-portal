...
<!-- [ Session ] end -->
    ...
    <?php 
        ...
        $sql = "Select * From tbl_category where cat_id = '$id' order by cat_id";
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form method="POST" action="process/updatecategory.php?id=<?php echo $_GET["id"]; ?>">
                                                        <div class="form-group col-md-12">
                                                            <label>Category Name</label>
                                                            <input type="text" class="form-control" id="catname" name="catname" value="<?php echo $users["cat_name"]; ?>" placeholder="Enter Category Name" required>
                                                        </div>
                                                        <div class="form-group col-md-12">
