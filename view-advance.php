                                                ...
                                                <table id="example" class="table">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            <td>
                                                            <a class="btn btn-sm btn-info" href="update-advance.php?stid=<?php echo $row["adv_id"]; ?>">EDIT</a></td>
                                                            <td>
                                                            <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#exampleModal" onclick='removedata(<?php echo $row["adv_id"]; ?>)'>Delete</button></td>
                                                        </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
