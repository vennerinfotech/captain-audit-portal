                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="projectstatus.php">View Task Status</a></li>
                                                <li class="breadcrumb-item"><a href="#">Update Task</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="text-right m-3">
                                             <button onclick="window.location='projectstatus.php';" type="button" class="btn btn-sm btn-primary">View Task</button>
                                        </div>
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-12">
