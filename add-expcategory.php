                                                            ...
                                                            <tbody>
                                                                ...
                                                                $counter=1;
                                                                    while ($users = mysqli_fetch_assoc($result)) {
                                                                        ...
                                                                        echo "<td><a class='btn btn-sm btn-success' href=\"update-category.php?id=$users[cat_id]\"><i class='feather icon-check-circle'></i>Edit</a><a class='btn btn-sm btn-danger' href=\"process/delete-category.php?id=$users[cat_id]\"><i class='feather icon-slash'></i>Delete</a></td>";
                                                                        echo "</tr>";
                                                                    }
                                                                ?>
                                                            </tbody>
