				...
				<div class="dropdown drp-user">
					...
					<div class="dropdown-menu dropdown-menu-right profile-notification">
						<div class="pro-head">
							...
							<a href="process/session.php?logout='1'" class="dud-logout" title="Logout">
...
<marquee  width="100%" style="margin-top: 130px;">
	<?php 
		$sql = "SELECT * FROM `user_notification` where `n_role` = '" . $_SESSION['role'] . "' and `n_status`= '1'";
		$data = mysqli_query($conn, $sql);
		$count = 0;
		while($row = mysqli_fetch_assoc($data)){
			if($count > 0){
				echo "  <b style='color:red; font-wight:700; font-size:18px;'>".($count+1).".".$row['n_title']."<b> ";
			}else{
				echo "<b style='color:red; font-wight:700; font-size:18px;'>".($count+1).". ".$row['n_title']."<b>";
			}
			$count++;
