...
<?php 
    ...
    $sql = "SELECT * FROM `tbl_personaltask` where u_id = '$id'";
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="personaltask.php">Personal Task</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form action="process/newpersonaltask.php" method="POST" enctype="multipart/form-data">
                                                    <div class="row">
                                            ...
                                            <div style="float: right;">
                                                <a class='btn btn-sm btn-danger' href="PDF/Personaltask.php"><i class='feather icon-check-circle'> PDF</i></a>
                                                <a class='btn btn-sm btn-success' href="Excel/Personaltask.php"><i class='feather icon-check-circle'> EXCEL</i></a>
                                            </div>
                                                        ...
                                                        $counter=1;
                                                            while ($users = mysqli_fetch_assoc($result)) {
                                                                 ...
                                                                 if($users['status']=="Due")
                                                                {
                                                                    ...
                                                                    echo "<td><a class='btn btn-sm btn-primary' href=\"personaltasksubmit.php?pid=$users[pt_id]&uid=$users[u_id]\"><i class='feather icon-thumbs-up'></i>Submit</a></td>";
                                                                }
                                                                else
                                                                {
                                                                    echo "<td style='color:green;'>".$users['status']."</td>";
                                                                 
                                                                     echo "<td><a style='pointer-events:none;' class='btn btn-sm btn-primary' href=\"personaltasksubmit.php?pid=$users[pt_id]&uid=$users[u_id]\"><i class='feather icon-thumbs-up'></i>Submit</a></td>";
                                                                }
